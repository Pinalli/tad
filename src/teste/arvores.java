...
https://github.com/LuisAraujo/Estrutura-de-Dados-em-Java
http://home.ufam.edu.br/hiramaral/04_SIAPE_FINAL_2016/SIAPE_Biblioteca%20Geral/00000_MeDSE_Mendeley_2015/MeDSE_JAVA_PDF/Livro%20Estrutura%20de%20Dados%20e%20Algoritmos%20em%20Java.pdf
 */
package teste;
...
public class arvores {
    ...
    public class Tree {
        ...
        public Node no_sucessor(Node apaga) { // O parametro é a referencia para o No que deseja-se apagar
            ...
            Node sucessor = apaga;
            Node atual = apaga.dir; // vai para a subarvore a direita
